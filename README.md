...
Extensão para coletar produtos da Nike Brasil automaticamente.

## 📥 Instalação Fácil

### 1️⃣ Baixe a Extensão:
No Google Chrome, procure por "Tampermonkey" na Chrome Web Store
Ou acesse direto: https://chrome.google.com/webstore/detail/tampermonkey/dhdgffkkebhmkfjojejmpbldmpobfkfo

### 2️⃣ Instale o Script:
1. Clique no ícone do Tampermonkey
2. Selecione "Criar um novo script"
3. APAGUE TODO O CÓDIGO que está lá
4. COLE O CÓDIGO COMPLETO ABAIXO dentro do editor do Tampermonkey:
...
1. Acesse: www.nike.com.br
2. Navegue para produtos (ex: Tênis, Camisetas)
3. Clique no botão 🚀 "INICIAR COLETA"
4. Aguarde terminar (vai coletar tudo!)
5. Baixe o arquivo JSON automaticamente

## ✨ O que ele faz

✅ Coleta nome, preço, categoria e foto dos produtos
✅ Navega sozinho por todas as páginas
✅ Marca produtos coletados com AZUL
✅ Gera arquivo JSON completo
✅ Design profissional em AZUL

## 🎯 Botões Principais

🚀 INICIAR COLETA - Começa tudo automático
⏹️ PARAR COLETA - Para quando quiser
💾 BAIXAR JSON - Pega os dados coletados

## ❓ Problemas Comuns

🔹 Não aparece? → Recarrega a página (F5)
🔹 Não coletou tudo? → Clique em Iniciar de novo
🔹 Não baixou? → Verifique bloqueador de pop-ups

## ⚠️ Importante

Use apenas para fins educacionais
Respeite os termos do site da Nike

---

**Instale o Tampermonkey, depois cole o script, e é só usar!** 🎉

Feito com ❤️ para automação web
EOF
